...
| ④ 硬件库 | 20 款 GPU(V100/T4/3090/4090/5090/A10/L40S/A100/H100/**H200/B200/B300/RTX PRO 6000/DGX Spark**/MI250X/M2 Ultra)、3 款 CPU 平台、DDR5 内存条,点击或拖放到画板 |
| ⑤ 部署画板 | 多卡/多内存自由组合,实时汇总显存、带宽、内存;**集群拓扑图**:GPU↔NVSwitch/卡间直连/PCIe↔CPU↔内存,每条链路标注速率(GB/s);互联方式可选/自动推断(NVLink 2/3/4/5、xGMI、PCIe 3/4/5、IB 400G、100GbE) |
