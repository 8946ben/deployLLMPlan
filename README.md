...
| ④ 硬件库 | 19 款 GPU 卡(V100/V100S-PCIE/T4/3090/4090/5090/A10/L40S/A100/H100/**H200/B200/B300/RTX PRO 6000**/MI250X)、5 款 CPU 平台、DDR5 内存条、**FPGA**(Alinx AXU9EGB,规格取自 LLM_FPGA 实测工程)、**整机 4 成员**(DGX-1、思腾合力、Mac Studio M2 Ultra、DGX Spark——添加时自动展开为部件),点击或拖放到画板 |
