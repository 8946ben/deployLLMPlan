...
### 新增
- **整机类硬件**:硬件库新增「整机」分类,添加到画板时自动展开为组成部件(GPU/CPU/内存),接入既有分析与拓扑逻辑;首批成员 NVIDIA DGX-1(8×V100 16GB,官方规格)与思腾合力 GPU 服务器(8×V100 32GB,占位配置待核实)
- CPU 平台新增 Intel Xeon E5-2698 v4 ×2(DGX-1 原装,40核/12通道 DDR4)
